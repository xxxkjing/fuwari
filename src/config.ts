...
export const siteConfig: SiteConfig = {
  title: 'MetaIllusion的个人博客',
  subtitle: '一个高中生的互联网日记',
  ...
  favicon: [    // Leave this array empty to use the default favicon
     {
       src: 'assets/images/pic.jpeg'    // Path of the favicon, relative to the /public directory
...
export const navBarConfig: NavBarConfig = {
  links: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/xxxkjing',     // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
  avatar: 'assets/images/pic.jpeg',  // Relative to the /src directory. Relative to the /public directory if it starts with '/'
  name: 'MetaIllusion',
  bio: '愿这份友谊长存',
  links: [
    {
